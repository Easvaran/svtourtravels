          ...
          {activeTab === "general" && (
            <section className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <FileTextIcon className="absolute left-4 top-4 text-gray-400 group-focus-within:text-[#00bcd4] transition-colors" size={20} />
                  <textarea
          ...
          {activeTab === "seo" && (
            <section className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
              <h3 className="text-xl font-black text-gray-900 flex items-center space-x-2">
                <span className="w-8 h-8 bg-[#00bcd4]/10 text-[#00bcd4] rounded-lg flex items-center justify-center text-sm">SEO</span>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <textarea
                      ...
                      className="w-full bg-gray-50 border-2 border-transparent rounded-2xl py-4 pl-12 pr-6 focus:border-[#00bcd4]/10 focus:bg-white outline-none transition-all font-bold text-gray-900 min-h-[120px] resize-none"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <ImageIcon className="absolute left-4 top-4 text-gray-400 group-focus-within:text-[#00bcd4] transition-colors" size={20} />
                    <input
                      type="text" 
                      placeholder="Alternative text for service image"
                      className="w-full bg-gray-50 border-2 border-transparent rounded-2xl py-4 pl-12 pr-6 focus:border-[#00bcd4]/10 focus:bg-white outline-none transition-all font-bold text-gray-900"
