...
export default function PaymentSuccessPage() {
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 pt-32 pb-24">
      <Suspense fallback={
        <div className="max-w-xl w-full bg-white rounded-[3rem] p-10 md:p-16 text-center shadow-2xl animate-pulse">
          <div className="w-24 h-24 bg-gray-100 rounded-full mx-auto mb-8" />
          <div className="h-10 bg-gray-100 rounded-xl w-3/4 mx-auto mb-4" />
          <div className="h-4 bg-gray-100 rounded-lg w-full mx-auto" />
        </div>
      }>
