    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 bg-[#0870b8] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            Our Professional <span className="text-[#00bcd4]">Services</span>
          </motion.h1>
          ...
          >
            From airport transfers to outstation rentals, we provide reliable 
            taxi services tailored to your specific travel needs.
          </motion.p>
        </div>
      </section>
